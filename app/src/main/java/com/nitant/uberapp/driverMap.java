...
public class driverMap extends FragmentActivity implements OnMapReadyCallback {
    ...
    SupportMapFragment mMapFragment; // MapView UI element

    GoogleMap mGoogleMap; // object that represents googleMap and allows us to use Google Maps API features

    Marker driverMarker; // Marker to display driver's location
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back = findViewById(R.id.trackbackBtn);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent i = new Intent(driverMap.this,CustomerOrderStatusPage.class);
                startActivity(i);
            }
        });
        ...
        MainActivity.pubnub.addListener(new SubscribeCallback() {
            ...
            public void message(PubNub pub, final PNMessageResult message) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            LinkedHashMap newLocation = JsonUtil.fromJson(message.getMessage().toString(), LinkedHashMap.class);
     ...
     */
    public void updateUI(Map<String, String> newLoc) {
        ...
        if (driverMarker != null) {
            ...
            driverMarker = mGoogleMap.addMarker(new MarkerOptions().position(newLocation).
                    icon(BitmapDescriptorFactory.fromResource(R.drawable.car)).title("Tool Location"));
        }
    }
     ...
     */
    public void animateCar(final LatLng destination) {
